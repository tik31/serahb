...
ENTITY sf2_fifo_sf2_fifo_0_corefifo_async IS
   GENERIC (
      -- --------------------------------------------------------------------------
...
END ENTITY sf2_fifo_sf2_fifo_0_corefifo_async;

ARCHITECTURE translated OF sf2_fifo_sf2_fifo_0_corefifo_async IS

   --AHK CONSTANT HIGH_FREQUENCY : integer :=  (t_fwft(FWFT, PREFETCH));
   CONSTANT HIGH_FREQUENCY : integer := 0;

   COMPONENT sf2_fifo_sf2_fifo_0_corefifo_doubleSync
      GENERIC (
   ...
   COMPONENT sf2_fifo_sf2_fifo_0_corefifo_grayToBinConv
      GENERIC (
         ADDRWIDTH                      :  integer := 3);    
      PORT (
...
BEGIN
   ...
   -- --------------------------------------------------------------------------
   Wr_corefifo_doubleSync : sf2_fifo_sf2_fifo_0_corefifo_doubleSync 
      GENERIC MAP (
   ...
   -- --------------------------------------------------------------------------
   Rd_corefifo_doubleSync : sf2_fifo_sf2_fifo_0_corefifo_doubleSync 
      GENERIC MAP (
            SYNC_RESET => SYNC_RESET,
   ...
   -- --------------------------------------------------------------------------
   Rd_corefifo_grayToBinConv : sf2_fifo_sf2_fifo_0_corefifo_grayToBinConv 
      GENERIC MAP (
         ADDRWIDTH => READ_DEPTH)
      PORT MAP (
   ...
   -- --------------------------------------------------------------------------
   Wr_corefifo_grayToBinConv : sf2_fifo_sf2_fifo_0_corefifo_grayToBinConv 
      GENERIC MAP (
         ADDRWIDTH => WRITE_DEPTH)
      PORT MAP (
   ...
   -- Instance::Sync Read gray pointer
   -- --------------------------------------------------------------------------
   Rd_doubleSync_fwft : sf2_fifo_sf2_fifo_0_corefifo_doubleSync 
      GENERIC MAP (
            SYNC_RESET => SYNC_RESET,
         ADDRWIDTH => READ_DEPTH)
      PORT MAP (
   ...
   -- Instance::Read gray-to-binary conversion logic
   -- --------------------------------------------------------------------------
   Rd_grayToBinConv_fwft : sf2_fifo_sf2_fifo_0_corefifo_grayToBinConv 
      GENERIC MAP (
         ADDRWIDTH => READ_DEPTH)
      PORT MAP (
