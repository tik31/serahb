...
ENTITY fifo4kx8_sf2_fifo4kx8_sf2_0_corefifo_async IS
   GENERIC (
      -- --------------------------------------------------------------------------
...
END ENTITY fifo4kx8_sf2_fifo4kx8_sf2_0_corefifo_async;

ARCHITECTURE translated OF fifo4kx8_sf2_fifo4kx8_sf2_0_corefifo_async IS

   --AHK CONSTANT HIGH_FREQUENCY : integer :=  (t_fwft(FWFT, PREFETCH));
   CONSTANT HIGH_FREQUENCY : integer := 0;

   COMPONENT fifo4kx8_sf2_fifo4kx8_sf2_0_corefifo_doubleSync
      GENERIC (
   ...
   COMPONENT fifo4kx8_sf2_fifo4kx8_sf2_0_corefifo_grayToBinConv
      GENERIC (
         ADDRWIDTH                      :  integer := 3);    
      PORT (
...
BEGIN
   ...
   -- --------------------------------------------------------------------------
   Wr_corefifo_doubleSync : fifo4kx8_sf2_fifo4kx8_sf2_0_corefifo_doubleSync 
      GENERIC MAP (
   ...
   -- --------------------------------------------------------------------------
   Rd_corefifo_doubleSync : fifo4kx8_sf2_fifo4kx8_sf2_0_corefifo_doubleSync 
      GENERIC MAP (
            SYNC_RESET => SYNC_RESET,
   ...
   -- --------------------------------------------------------------------------
   Rd_corefifo_grayToBinConv : fifo4kx8_sf2_fifo4kx8_sf2_0_corefifo_grayToBinConv 
      GENERIC MAP (
         ADDRWIDTH => READ_DEPTH)
      PORT MAP (
   ...
   -- --------------------------------------------------------------------------
   Wr_corefifo_grayToBinConv : fifo4kx8_sf2_fifo4kx8_sf2_0_corefifo_grayToBinConv 
      GENERIC MAP (
         ADDRWIDTH => WRITE_DEPTH)
      PORT MAP (
   ...
   -- Instance::Sync Read gray pointer
   -- --------------------------------------------------------------------------
   Rd_doubleSync_fwft : fifo4kx8_sf2_fifo4kx8_sf2_0_corefifo_doubleSync 
      GENERIC MAP (
            SYNC_RESET => SYNC_RESET,
         ADDRWIDTH => READ_DEPTH)
      PORT MAP (
   ...
   -- Instance::Read gray-to-binary conversion logic
   -- --------------------------------------------------------------------------
   Rd_grayToBinConv_fwft : fifo4kx8_sf2_fifo4kx8_sf2_0_corefifo_grayToBinConv 
      GENERIC MAP (
         ADDRWIDTH => READ_DEPTH)
      PORT MAP (
