...
-- Vendor codes
  ...
  constant VENDOR_MIPT	     : amba_vendor_type := 16#33#;
...
-- MIPT device id's--------------------------------------------
  constant MIPT_ADVRST         : amba_device_type := 16#001#;
  constant MIPT_SPI 	       : amba_device_type := 16#002#;
  constant MIPT_FLASHROM       : amba_device_type := 16#003#;
  constant MIPT_FPF2195        : amba_device_type := 16#004#;
  constant MIPT_DS1820         : amba_device_type := 16#005#;
  constant MIPT_VERSION        : amba_device_type := 16#006#;
  constant MIPT_APBTKS         : amba_device_type := 16#007#;
  constant MIPT_APBUART        : amba_device_type := 16#008#;
  constant MIPT_DDRSFAHB       : amba_device_type := 16#009#;
  constant MIPT_DDRSFAPB       : amba_device_type := 16#00A#;
  constant MIPT_1553           : amba_device_type := 16#00B#;
...
-- pragma translate_off
  ...
  constant MIPT_DESC : vendor_description := "MIPT                    ";

  constant mipt_device_table : device_table_type := (
	 MIPT_ADVRST      => "MIPT Advanced reset module     ",
     MIPT_SPI         => "Simple SPI module              ",
     MIPT_FLASHROM    => "Actel FlashROM                 ",
     MIPT_FPF2195     => "FPF2195 Current control module ",
	 MIPT_DS1820      => "DS1820 1-wire reader module    ",
	 MIPT_VERSION     => "Version info (build & date)    ",
     MIPT_APBTKS      => "Basic timekeeper service       ",
	 MIPT_APBUART     => "IRZ implementation of apbuart  ",
	 MIPT_DDRSFAHB    => "Bridge to AXI DDR AHB If       ",
	 MIPT_DDRSFAPB    => "Bridge to AXI DDR APB If       ",
     others           => "Unknown Device                 ");

  constant mipt_lib : vendor_library_type := (
     vendorid 	       => VENDOR_MIPT,
     vendordesc        => MIPT_DESC,
     device_table      => mipt_device_table
   );
